defmodule Piyopiyoex3SamplePortfolioWeb.PortfolioLiveTest do
  use Piyopiyoex3SamplePortfolioWeb.ConnCase

  import Phoenix.LiveViewTest
  import Piyopiyoex3SamplePortfolio.PortfoliosFixtures
